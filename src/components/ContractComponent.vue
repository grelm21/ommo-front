...
const fillVkContainer = () => {
  ...
  const text = `Страховка любви от ОММО подписана! Твой черед! #страховкалюбви #ОММО`
    ...
    <div class="flex flex-col w-full items-center justify-center display-none" v-show="!loading">
      <div class="name-inputs">
        ...
        <div class="block text-justify handjet-normal text-[20px] text-white">
          ...
          первая песня. Для полной активации необходимо добавить нашу песню себе в пресейв на любой
